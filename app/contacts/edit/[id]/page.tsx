...
//   const { id } = use(params); // ✅ แก้ตาม Next.js 15 ใช้ use() unwrap Promise
...
//                     objectFit: 'cover',
//                     aspectRatio: '1 / 1'      // ✅ ป้องกันภาพยืด/บี้
//                   }}
//                 />
//               <button
//                 type="button"
...
// app/contacts/edit/[id]/page.tsx
// import { getContactById, updateContact } from '../../../../lib/actions'; // Path ที่แก้ไขแล้ว
...
//       <h1>Edit Contact</h1>
//       <form action={handleUpdateContact} style={{ display: 'grid', gap: '15px' }}>
//         <input type="hidden" name="id" value={contact.id} /> {/* Hidden ID field */}
//         <label>
//           First Name:
//           <input type="text" name="first_name" defaultValue={contact.first_name} required style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #ddd' }} />
//         </label>
